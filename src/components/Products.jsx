    ...
    <div className="products-container" id="product-section">
      ...
      <div className="outdoor-content">
        ...
        <p className="outdoor-text">
          ...
          med träning ca 2 ggr/v året om.
        </p>
        {!isMobile ? (
          <p>
            Träningen hos mig är varierande då ett pass är aldrig det andra
            likt. Träningen sker med kroppsvikt, gummiband, kettlebells, bollar,
      ...
      <div className="pt-content">
        ...
        {!isMobile ? (
          <p>
            Vi bygger upp ett tränings-program som passar just dig, antingen på
            gym, hemma eller ute eller online så du kan utföra träningen själv
            med hjälp utav ett träningsprogram som du kan ha i en app i
            ...
            <Collapse in={open}>
              <div id="example-collapse-text">
                <p>
                  ...
                  antingen på gym, hemma eller ute eller online så du kan utföra
                  träningen själv med hjälp utav ett träningsprogram som du kan
                  ha i en app i telefonen. Hör av dig till mig på så hittar vi
